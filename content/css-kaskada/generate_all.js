...
const dir = '/home/karel/akademie/content/css-kaskada';
...
:::check pretest
Co se stane, když mají dvě CSS pravidla stejný selektor a mění stejnou vlastnost, ale různé hodnoty?
...
> [!PITFALL]
> Styly deklarované MIMO vrstvy (unlayered styles) vždy vyhrávají nad styly VE vrstvách.

## Kde to najdeš v MDN
- [Kaskáda](https://developer.mozilla.org/en-US/docs/Web/CSS/Cascade)
...
## Kde to najdeš v MDN
- [Specificita](https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity)
...
## Kde to najdeš v MDN
- [Dědičnost](https://developer.mozilla.org/en-US/docs/Web/CSS/Inheritance)
