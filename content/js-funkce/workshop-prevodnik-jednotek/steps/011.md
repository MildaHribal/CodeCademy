...
Doplň funkci `funkceKrok11()`, která vrátí číslo 11.

# --hints--

`funkceKrok11()` musí vrátit 11.
```js
assert.equal(funkceKrok11(), 11, "funguje správně");
```
...
function funkceKrok10() { return 10; }
...
function funkceKrok11() { return 11; }
```
