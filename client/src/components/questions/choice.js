// Otázka s volbami (--answer-- / --correct--, kontrakt kap. 4). Odpovědi se míchají
// deterministicky podle klíče, takže při překreslení zůstanou na místě.
 ...
 */
export function createChoiceQuestion(question, { key, number, total, onChange }) {
