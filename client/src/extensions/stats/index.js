...
// Ikona: tři sloupce různé výšky (viewBox 0 0 16 16, tah barvou textu).
...
registerHeaderItem({ id: 'statistiky', order: 50, label: 'Statistiky', href: '#/statistiky', routes: ['stats'], icon: STATS_ICON });
